...
<div class="card">
  ...
  <table>
    <thead><tr>
      <th>#</th><th>Description</th><th class="r">Qty</th><th class="r">Rate</th><th class="r">GST</th><th class="r">Amount</th>
    </tr></thead>
    <tbody>
    ...
    <tfoot>
      <tr style="background:var(--bg)">
        <td colspan="5" style="text-align:right;font-weight:700;padding:11px 12px;font-size:13px">Grand Total</td>
