// ============================================================
// email-setup.js — page-specific JS for pages/email-setup.php
// Depends on: common.js, shared-data.js
// No pre-built file existed — built fresh. Default active tab is
// SMTP, which is rendered server-side from $settings (no JS load
// needed); other tabs lazy-load their data via emTab().
// ============================================================
