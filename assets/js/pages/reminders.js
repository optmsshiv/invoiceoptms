...
//     call sendEmailFromInvoice() for the email channel — added at
//     the bottom of this file (Phase 7), reads SMTP config from
//     STATE.settings.email_cfg (set up on email-setup.php, Phase 6).
//     WhatsApp channel uses wa-shared.js (Phase 3).
// ================================================================
...
// ============================================================
// Added retroactively (Phase 7) — sendReminderNow()/
// sendBalanceReminder()/sendPromiseReminder() above call this for
// the email channel. Was missing entirely from the original
// extraction (not referenced via onclick in reminders_body.html,
// only called programmatically) — found via a stale "not built yet"
// comment audit after Phase 6 (email-setup.php) was completed.
// ============================================================
