// ============================================================
// payments.js — page-specific JS for pages/payments.php
// Depends on: common.js, shared-data.js
//
// Built fresh from the current SPA's product/service payment-voucher
// system (api/payment_vouchers.php) — the OLD assets/js/payments.js
// in this repo was for a simpler invoice-only payments model and is
// superseded by this file. business_type decides which view renders,
// same gating as products.php will use (server-side, via $businessType
// already computed in layout_header.php / available client-side as
// SERVER.settings.business_type).
// ============================================================

const PMT = { page: 1, per: 10, list: [] };
const PMTS = { page: 1, per: 10, list: [] };
