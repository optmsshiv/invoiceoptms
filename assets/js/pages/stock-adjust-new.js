// ============================================================
// stock-adjust-new.js — page-specific JS for pages/stock-adjust-new.php
// Depends on: common.js, app.js, stock-shared.js
// initStockAdjustPage() replaces the old goToNewStockAdjustment() — it
// used to reset the SPA's hidden form div before showing it; here it just
// sets the form's defaults once, on page load.
// ============================================================

document.addEventListener('DOMContentLoaded', async () => {
  await bootStockPageState();
  await initStockAdjustPage();
});
