<?php
// ================================================================
//  pages/products/product-new.php
//  Full-page product entry — only used when business_type='product'
//  exactly. Service/Both tenants use the existing modal on
//  products.php (openAddProductModal) instead — matches the
//  original SPA's design, not extended to 'both' like Sales was.
// ================================================================
...
$pageScripts = ['/assets/js/shared-data.js', '/assets/js/product-new.js'];

include __DIR__ . '/../../includes/layout_header.php';
?>
    <div id="page-product-new" class="page active">
