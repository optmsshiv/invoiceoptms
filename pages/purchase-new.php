...
?>
    ...
    <!-- Add Supplier Modal (relocated from suppliers section — used by
         this page's "+" button next to the supplier dropdown) -->
...
<script src="/assets/js/pages/purchase-new.js"></script>
