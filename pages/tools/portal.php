...
?>
      ...
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;flex-wrap:wrap">
        <input type="text" class="table-search" placeholder="Search invoice, client…" oninput="window._portalPage=1;_renderPortalTable(this.value)" id="portal-search" style="width:190px">
        <select class="table-filter" id="portal-status-filter" onchange="window._portalPage=1;_renderPortalTable()">
        ...
        <select class="table-filter" id="portal-link-filter" onchange="window._portalPage=1;_renderPortalTable()">
