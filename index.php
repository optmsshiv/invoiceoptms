        ...
        <div class="create-form">
          ...
          <div class="form-section">
            ...
            <div class="form-grid g2">
              ...
              <div class="field g-full"><label>Bank Account Details</label><textarea id="f-bank" oninput="livePreview(); debounceSaveInvoiceDraft()"></textarea></div>
              <div class="field g-full"><label>Terms & Conditions</label><textarea id="f-tnc" oninput="livePreview(); debounceSaveInvoiceDraft()" style="min-height:72px" placeholder="Enter terms and conditions..."></textarea></div>
...
<div class="modal-overlay" id="modal-paid">
  <div class="modal modal-sm">
    ...
    <div class="modal-body" style="padding:24px">
      ...
      <div id="paid-remaining-box" style="display:none;margin-top:10px;background:#FFF8E1;border:1.5px solid #FFD54F;border-radius:8px;padding:10px 14px">
        <div style="font-size:12px;font-weight:700;color:#E65100;margin-bottom:4px">⚠️ Partial Payment</div>
        <div style="display:flex;justify-content:space-between;font-size:12px">
          <span>Total Invoice: <strong id="paid-rem-total" style="font-family:var(--mono)"></strong></span>
          <span>Received: <strong id="paid-rem-received" style="color:var(--teal);font-family:var(--mono)"></strong></span>
          <span>Remaining: <strong id="paid-rem-due" style="color:#E65100;font-family:var(--mono)"></strong></span>
        </div>
...
function openRowMenu(e, id) {
  ...
  menu.innerHTML = `
    ...
    <div class="rm-item ${editDisabled?'rm-disabled':''}" onclick="${editDisabled?'':\"rowMenuAction('edit')\"}" style="${editDisabled?'opacity:.4;cursor:not-allowed;':''}">
    ...
    <div class="rm-item ${canMarkPaid?'':'rm-disabled'}" onclick="${canMarkPaid?\"rowMenuAction('paid')\":''}" style="${canMarkPaid?'':'opacity:.4;cursor:not-allowed'}">
