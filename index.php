  ...
  <div style="background:${T.hbg};padding:28px 36px;display:flex;justify-content:space-between;align-items:flex-start;gap:20px">
    <div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:2px 16px">
        ...
        ${sc.website?`<div style="font-size:11px;color:${T.htag};font-weight:500;line-height:1.9">${sc.website}</div>`:''}
        ${sc.gst?`<div style="font-size:11px;color:${T.htag};font-weight:500;line-height:1.9">GSTIN: ${sc.gst}</div>`:''}
