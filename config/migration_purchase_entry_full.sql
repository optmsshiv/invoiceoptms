...
-- (some shared hosts don't grant that privilege).
-- ═══════════════════════════════════════════════════════════

SET @v22 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchases' AND column_name='gst_pct');
SET @sv22 = IF(@v22=0, 'ALTER TABLE purchases ADD COLUMN gst_pct DECIMAL(5,2) DEFAULT 0', 'SELECT 1');
...
SET @v23 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='variety_grade');
SET @sv23 = IF(@v23=0, 'ALTER TABLE purchase_items ADD COLUMN variety_grade VARCHAR(100) DEFAULT ''', 'SELECT 1');
PREPARE stv23 FROM @sv23; EXECUTE stv23; DEALLOCATE PREPARE stv23;

SET @v24 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='moisture_pct');
SET @sv24 = IF(@v24=0, 'ALTER TABLE purchase_items ADD COLUMN moisture_pct DECIMAL(5,2) DEFAULT 0', 'SELECT 1');
PREPARE stv24 FROM @sv24; EXECUTE stv24; DEALLOCATE PREPARE stv24;

SET @v25 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='quality_grade');
SET @sv25 = IF(@v25=0, 'ALTER TABLE purchase_items ADD COLUMN quality_grade VARCHAR(50) DEFAULT ''', 'SELECT 1');
PREPARE stv25 FROM @sv25; EXECUTE stv25; DEALLOCATE PREPARE stv25;

SET @v26 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='gross_weight');
SET @sv26 = IF(@v26=0, 'ALTER TABLE purchase_items ADD COLUMN gross_weight DECIMAL(12,3) DEFAULT 0', 'SELECT 1');
PREPARE stv26 FROM @sv26; EXECUTE stv26; DEALLOCATE PREPARE stv26;

SET @v27 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='tare_weight');
SET @sv27 = IF(@v27=0, 'ALTER TABLE purchase_items ADD COLUMN tare_weight DECIMAL(12,3) DEFAULT 0', 'SELECT 1');
PREPARE stv27 FROM @sv27; EXECUTE stv27; DEALLOCATE PREPARE stv27;

SET @v28 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='dhalta_pct');
SET @sv28 = IF(@v28=0, 'ALTER TABLE purchase_items ADD COLUMN dhalta_pct DECIMAL(5,2) DEFAULT 0', 'SELECT 1');
PREPARE stv28 FROM @sv28; EXECUTE stv28; DEALLOCATE PREPARE stv28;

SET @v29 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='dhalta_kg');
SET @sv29 = IF(@v29=0, 'ALTER TABLE purchase_items ADD COLUMN dhalta_kg DECIMAL(12,3) DEFAULT 0', 'SELECT 1');
PREPARE stv29 FROM @sv29; EXECUTE stv29; DEALLOCATE PREPARE stv29;

SET @v30 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='billable_weight');
SET @sv30 = IF(@v30=0, 'ALTER TABLE purchase_items ADD COLUMN billable_weight DECIMAL(12,3) DEFAULT 0', 'SELECT 1');
PREPARE stv30 FROM @sv30; EXECUTE stv30; DEALLOCATE PREPARE stv30;

SET @v31 = (SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='purchase_items' AND column_name='discount_pct');
SET @sv31 = IF(@v31=0, 'ALTER TABLE purchase_items ADD COLUMN discount_pct DECIMAL(5,2) DEFAULT 0', 'SELECT 1');
